...
{
public:
    MultiNozzleSyncDialog(wxWindow* parent, std::weak_ptr<VortekNozzleRack> rack);
    virtual void on_dpi_changed(const wxRect& suggested_rect) {};
...
private:
    ...
    bool UpdateUi(std::weak_ptr<VortekNozzleRack> rack, bool ignore_unknown=false, bool ignore_unreliable=false);

    bool UpdateOptionList(std::weak_ptr<VortekNozzleRack> rack, bool ignore_unknown, bool ignore_unreliable);
    void UpdateTip(std::weak_ptr<VortekNozzleRack> rack, bool ignore_unknown, bool ignore_unreliable);
    void UpdateButton(std::weak_ptr<VortekNozzleRack> rack, bool ignore_unknown, bool ignore_unreliable);
