...
void ConfigManipulation::toggle_print_fff_options(DynamicPrintConfig *config, const bool is_global_config)
{
    ...
    for (auto el : { "flow_weaving_z_amplitude", "flow_weaving_xy_amplitude", "flow_weaving_xy_path_amplitude", "flow_weaving_period", "flow_weaving_phase_offset", "flow_weaving_z_phase_offset", "flow_weaving_z_overlap", "flow_weaving_top_taper_layers", "flow_weaving_speed", "flow_weaving_taper_length", "flow_weaving_wall_overlap" })
