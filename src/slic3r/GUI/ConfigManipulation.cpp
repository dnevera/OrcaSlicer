...
void ConfigManipulation::toggle_print_fff_options(DynamicPrintConfig *config, const bool is_global_config)
{
    ...
    for (auto el : { "flow_weaving_z_amplitude", "flow_weaving_xy_amplitude", "flow_weaving_xy_path_amplitude", "flow_weaving_period", "flow_weaving_phase_offset", "flow_weaving_z_overlap" })
