...
// H2C: Event sent when a drag-drop operation completes (filament moved between panels).
// Reference to BBS: BambuStudio/src/slic3r/GUI/DragDropPanel.hpp – wxEVT_DRAG_DROP_COMPLETED
...
{
public:
    // H2C: added has_title and is_sub parameters for SeparatedDragDropPanel sub-panels.
    // Reference to BBS: BambuStudio/src/slic3r/GUI/DragDropPanel.hpp – DragDropPanel ctor
...
// H2C: Wrapper panel for Right extruder that splits into High Flow + Standard sub-panels
// when the extruder is in Hybrid mode. When not Hybrid, shows a single unified panel.
// Reference to BBS: BambuStudio/src/slic3r/GUI/DragDropPanel.hpp – class SeparatedDragDropPanel
