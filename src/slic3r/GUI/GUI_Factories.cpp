...
std::map<std::string, std::vector<SimpleSettingData>> SettingsFactory::PART_CATEGORY_SETTINGS =
    {{L("Quality"),
      {{"ironing_type", "", 8},
       ...
       {"zaa_min_z", "", 4},
       {"micro_molding", "", 5},
       {"micro_molding_cavity_diameter", "", 6},
       {"micro_molding_layers_span", "", 7},
       {"micro_molding_flow_multiplier", "", 8},
       {"micro_molding_temp_offset", "", 9},
       {"micro_molding_lock_ratio", "", 10},
       {"micro_molding_neck_layers", "", 11},
       {"micro_molding_head_layers", "", 12},
       {"flow_weaving_z_amplitude", "", 13},
       {"flow_weaving_xy_amplitude", "", 14},
       {"flow_weaving_period", "", 15}}},
     {L("Strength"),
      {{"wall_loops", "", 1},
